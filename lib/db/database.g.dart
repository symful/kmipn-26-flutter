...
class $LocalTaskVisitsTable extends LocalTaskVisits
    with TableInfo<$LocalTaskVisitsTable, LocalTaskVisit> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $LocalTaskVisitsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idempotencyKeyMeta = const VerificationMeta(
    'idempotencyKey',
  );
  @override
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'local_task_visits';
  @override
  VerificationContext validateIntegrity(
    Insertable<LocalTaskVisit> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {idempotencyKey};
  @override
  LocalTaskVisit map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return LocalTaskVisit(
      idempotencyKey: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}idempotency_key'],
      )!,
  ...
  @override
  $LocalTaskVisitsTable createAlias(String alias) {
    return $LocalTaskVisitsTable(attachedDatabase, alias);
  }
}

class LocalTaskVisit extends DataClass implements Insertable<LocalTaskVisit> {
  final String idempotencyKey;
  final String taskId;
  ...
  LocalTaskVisitsCompanion toCompanion(bool nullToAbsent) {
    return LocalTaskVisitsCompanion(
      idempotencyKey: Value(idempotencyKey),
      taskId: Value(taskId),
  ...
  factory LocalTaskVisit.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  LocalTaskVisit copyWithCompanion(LocalTaskVisitsCompanion data) {
    return LocalTaskVisit(
      idempotencyKey: data.idempotencyKey.present
          ? data.idempotencyKey.value
          : this.idempotencyKey,
  ...
  @override
  String toString() {
    return (StringBuffer('LocalTaskVisit(')
          ..write('idempotencyKey: $idempotencyKey, ')
          ..write('taskId: $taskId, ')
...
class LocalTaskVisitsCompanion extends UpdateCompanion<LocalTaskVisit> {
  final Value<String> idempotencyKey;
  final Value<String> taskId;
  ...
  final Value<DateTime> createdAt;
  final Value<int> rowid;
  const LocalTaskVisitsCompanion({
    this.idempotencyKey = const Value.absent(),
    this.taskId = const Value.absent(),
  ...
  LocalTaskVisitsCompanion.insert({
    required String idempotencyKey,
    required String taskId,
    ...
    this.rowid = const Value.absent(),
       ...
       visitDataJson = Value(visitDataJson),
       createdAt = Value(createdAt);
  static Insertable<LocalTaskVisit> custom({
    Expression<String>? idempotencyKey,
    Expression<String>? taskId,
  ...
  LocalTaskVisitsCompanion copyWith({
    Value<String>? idempotencyKey,
    Value<String>? taskId,
  ...
  @override
  String toString() {
    return (StringBuffer('LocalTaskVisitsCompanion(')
          ..write('idempotencyKey: $idempotencyKey, ')
          ..write('taskId: $taskId, ')
          ..write('visitDataJson: $visitDataJson, ')
          ..write('syncStatus: $syncStatus, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $LocalTaskVisitsTable localTaskVisits = $LocalTaskVisitsTable(
    this,
  );
  @override
...
typedef $$LocalTasksTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$LocalTaskVisitsTableCreateCompanionBuilder =
    LocalTaskVisitsCompanion Function({
      required String idempotencyKey,
      required String taskId,
      required String visitDataJson,
      Value<int> syncStatus,
...
typedef $$LocalTaskVisitsTableUpdateCompanionBuilder =
    LocalTaskVisitsCompanion Function({
      Value<String> idempotencyKey,
      Value<String> taskId,
      Value<String> visitDataJson,
...
class $$LocalTaskVisitsTableFilterComposer
    extends Composer<_$AppDatabase, $LocalTaskVisitsTable> {
  $$LocalTaskVisitsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LocalTaskVisitsTableOrderingComposer
    extends Composer<_$AppDatabase, $LocalTaskVisitsTable> {
  $$LocalTaskVisitsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LocalTaskVisitsTableAnnotationComposer
    extends Composer<_$AppDatabase, $LocalTaskVisitsTable> {
  $$LocalTaskVisitsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LocalTaskVisitsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $LocalTaskVisitsTable,
          LocalTaskVisit,
          $$LocalTaskVisitsTableFilterComposer,
          $$LocalTaskVisitsTableOrderingComposer,
          $$LocalTaskVisitsTableAnnotationComposer,
          $$LocalTaskVisitsTableCreateCompanionBuilder,
          $$LocalTaskVisitsTableUpdateCompanionBuilder,
          (
            LocalTaskVisit,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$LocalTaskVisitsTableTableManager(
    _$AppDatabase db,
    $LocalTaskVisitsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$LocalTaskVisitsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$LocalTaskVisitsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$LocalTaskVisitsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> idempotencyKey = const Value.absent(),
                Value<String> taskId = const Value.absent(),
...
typedef $$LocalTaskVisitsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $LocalTaskVisitsTable,
      LocalTaskVisit,
      ...
      (
        LocalTaskVisit,
        BaseReferences<_$AppDatabase, $LocalTaskVisitsTable, LocalTaskVisit>,
      ),
      LocalTaskVisit,
      PrefetchHooks Function()
    >;
...
class $AppDatabaseManager {
  ...
  $$LocalTaskVisitsTableTableManager get localTaskVisits =>
      $$LocalTaskVisitsTableTableManager(_db, _db.localTaskVisits);
}

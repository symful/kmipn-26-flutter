...
/// M-14 "Lengkapi laporan" CTA button widget.
///
/// Matches PantauDesa Screens.dc.html line 221 design spec:
...
/// - margin-top: 11px
///
/// Used in M-14 Detail Laporan screen status action banner.
class M14LengkapiCTA extends StatelessWidget {
  /// Called when the CTA button is tapped.
  final VoidCallback? onTap;

  const M14LengkapiCTA({super.key, this.onTap});

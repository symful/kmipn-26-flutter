...
/// S-04 Radio button group for kondisi (condition) selection.
///
/// Displays a vertical list of radio options for selecting the condition
/// of an item during surveyor visit form.
///
...
/// )
/// ```
class S04KondisiRadio extends StatelessWidget {
  ...
  /// Creates a kondisi radio button group.
  ///
  /// All parameters are required.
  const S04KondisiRadio({
    super.key,

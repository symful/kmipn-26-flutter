    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(l10n.mobileASimilarCaseWasFoundNearThisLocation),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      [
                        if (caseItem.distance.isNotEmpty &&
                            caseItem.distance != '—' &&
                            caseItem.distance != '-')
                          caseItem.distance,
                        if (caseItem.similarityPercent != null)
                          '${l10n.kemiripanLabel} ${caseItem.similarityPercent}%',
                        if (caseItem.reportCount != null)
                          l10n.reportCount(caseItem.reportCount!),
                      ].join(' · '),
                      style: TextStyle(

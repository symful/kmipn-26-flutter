...
///
/// A multiline text field for entering field notes during a field visit.
/// Displays a label "Catatan lapangan" above the input and an optional
/// character count indicator below the input.
///
/// Design tokens used:
/// - Input border: SigapColorScheme.of(context).borderCard (#E4E7E2)
/// - Input background: SigapColorScheme.of(context).bgCard (#FFFFFF)
/// - Input text: SigapColorScheme.of(context).textPrimary (#17191C)
/// - Placeholder text: SigapColorScheme.of(context).textTertiary (#616770)
/// - Label text: SigapColorScheme.of(context).textPrimary (#17191C)
/// - Character count text: SigapColorScheme.of(context).textTertiary (#616770)
...
class _CatatanTextField extends StatelessWidget {
  ...
  InputDecoration _inputDecoration(BuildContext context, String hint) {
    return InputDecoration(
      ...
      filled: true,
      fillColor: SigapColorScheme.of(context).bgCard,
      contentPadding: const EdgeInsets.all(SigapSpacing.md),
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(SigapRadius.md),
        borderSide: BorderSide(color: SigapColorScheme.of(context).borderCard),
      ),
